...
The software package MAGES uses two general codes:

- ``MAGSENES``: calculates sensitivity.
...
----------------------
  ...
  .. toctree::
    ...
    Sensitivity calculation (MAGSENES) <programs/magsenes>
    Inversion (MAGINVES) <programs/maginves>
